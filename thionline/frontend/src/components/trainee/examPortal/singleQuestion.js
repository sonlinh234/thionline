    ...
    onAnswerChange=(d1,d2,d3)=>{
        ...
        if(d2){
            if(this.state.ticked===ansCount){
                return Alert('error','Lỗi!','Xoá lựa chọn hiện tại để chọn lựa chọn khác')
            }
            else{
                    ...
                    <Row>
                        ...
                        <Col span={22}>
                            <Radio.Group  style={{float:'right'}}>
                                <Radio.Button style={{background:'#009999',color:'#fff'}}>{this.props.trainee.questions[this.props.trainee.activeQuestionIndex].anscount===1?"Một đáp án":"Nhiều đáp án"}</Radio.Button>
                                <Radio.Button style={{background:'#009999',color:'#fff'}}>Điểm : {this.props.trainee.questions[this.props.trainee.activeQuestionIndex].weightage}</Radio.Button>
                            </Radio.Group>
                        </Col>
                    </Row>
                    {
                ...
                <div className="control-button-in-exam-portal">
                    <Button.Group>
                        ...
                        <Button type="default" onClick={this.mark}>
                                <Icon type="flag" />
                                {!this.props.trainee.answers[this.props.trainee.activeQuestionIndex].isMarked?"Đánh dấu câu hỏi":"Bỏ đánh dấu"}
                        </Button>
                        {this.props.trainee.activeQuestionIndex===this.props.trainee.questions.length-1?
                            ...
                            <Button style={{background:'#009999',color:'#fff'}} onClick={this.next}>
                                {this.state.AnswerSelected?"Lưu & Tiếp tục": "Tiếp tục"}
                                <Icon type="right" />
                            </Button>
                        }
