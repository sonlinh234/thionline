    ...
    render(){
        ...
        return (
            <div className="answer-table-outer">
                <Title className="answer-table-heading" level={4}>Kết quả</Title>
                <div className="answer-table-wrapper">
                    <Descriptions bordered title={null} border size="small">
                        <Descriptions.Item label="Tên">{td.name}</Descriptions.Item>
                        <Descriptions.Item label="Email">{td.emailid}</Descriptions.Item>
                        <Descriptions.Item label="Liên hệ">{td.contact}</Descriptions.Item>
                        <Descriptions.Item label="Điểm">{this.state.TotalScore}</Descriptions.Item>
                    </Descriptions>
                    <br/>
                    <Table 
                        size="small"
