...
class AllTopics extends Component {
  ...
  closeModal = ()=>{
    this.props.ChangeSubjectModalState(false,null,'Môn mới');
  }
      ...
      const columns = [
        ...
        return (
            <div className="admin-table-container">
              <Button type="primary" icon="file-text" style={{marginBottom:'10px'}} onClick={()=>this.openModal(null,'Thêm môn')}>
                Thêm môn
              </Button> 
              <div className="register-trainer-form-header">
                <Title level={4} style={{color:'#fff',textAlign:'center'}}>Danh sách các môn</Title>
              </div>
              <Table 
                bordered={true} 
                columns={columns} 
