    ...
    render() {
        ...
        return (
            <div className="candidate-list-header-container"> 
                <Button className="reload-button" type="primary" icon="reload" loading={this.state.loading} onClick={this.refreshUserList}>Tải lại!</Button>
                <div className="register-trainer-form-header">
                    <Title level={4} style={{color:'#fff',textAlign:'center'}}>Danh sách đăng ký</Title>
                </div> 
                <Table 
                columns={columns} 
                bordered={true} 
