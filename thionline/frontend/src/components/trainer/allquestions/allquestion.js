        ...
        return (
            <div className="admin-table-container">
              <div>
                <Row>
                  <Col span={12}>
                    <Button type="primary" icon="question-circle" style={{marginBottom:'10px'}} onClick={()=>this.openNewModal('Thêm câu hỏi')}>
                      Thêm câu hỏi mới
                    </Button>
                  </Col>
                  <Col span={12}>
              ...
              <div className="register-trainer-form-header">
                <Title level={4} style={{color:'#fff',textAlign:'center'}}>Danh sách câu hỏi</Title>
              </div>
              <Table 
                bordered={true} 
                columns={columns} 
