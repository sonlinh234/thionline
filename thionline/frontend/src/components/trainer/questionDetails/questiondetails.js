            ...
            <div>
                <Skeleton loading={this.state.loading} active avatar>
                    <Tabs defaultActiveKey="1" onChange={ (e)=>this.tabChange(e)}>
                        <TabPane tab={ <span><Icon type="home" />Thông tin chi tiết</span> } key="1">
    ...
    return (
        <div>
            <Descriptions bordered title="" border size="small" column={{ xxl: 1, xl: 1, lg: 1, md: 1, sm: 1, xs: 1 }}>
                ...
                <Descriptions.Item label="Môn">{props.details.subject.topic}</Descriptions.Item>
                <Descriptions.Item label="Độ khó">{props.details.difficulty}</Descriptions.Item>
                <Descriptions.Item label="Số đáp án">{props.details.anscount}</Descriptions.Item>
                <Descriptions.Item label="Điểm">{props.details.weightage}</Descriptions.Item>
                <Descriptions.Item label="Tạo bởi">{props.details.createdBy.name}</Descriptions.Item>
                <Descriptions.Item label="Tạo vào">{moment(props.details.createdAt).format("DD/ MM/YYYY , hh:mm:ss")}</Descriptions.Item>
            </Descriptions>
        </div>
    )
}
