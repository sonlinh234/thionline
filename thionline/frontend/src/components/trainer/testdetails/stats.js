...
export default class Stats extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            passData: [0, 0],
            passLable: ['Trượt', 'Đạt'],
            stat: ['91% đến 100%', '81% đến 90%', '71% đến 80%', '61% đến 70%', '50% đến 60%', 'Dưới 50%'],
                ...
                <div>
                    <Card >
                        <div className="download-section">
                            <b>Tải bảng điểm excel.</b>
                            <a href={this.props.file} target="_blank" rel="noopener noreferrer" className="download-xlsx">Tải xuống</a>
                        </div>
                    </Card>
                </div>
